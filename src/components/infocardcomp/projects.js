...
function Projects(props) {
    ...
    useEffect(()=>{
        ...
        //   observer.observe(document.querySelectorAll('.project-card')[5]);
                ...
                <div class="flex flex-row project-card h-5/6 w-9/12 m-auto">
                    ...
                    <div class="flex flex-col h-full w-full">
                        ...
                        <div class="flex flex-row h-3/6 w-full">
                            ...
                            <div class="flex h-full w-full">
                                <a class="m-auto" href="https://github.com/nalin243/uniplacer-insight/" target="_blank" rel="noopener noreferrer">
                                    <button class="project-button rounded-xl px-8">Go to code</button>
                                </a>
                            </div>
                        </div>
            ...
            <div class="flex h-3/6 w-full shrink-0">
                <div class="flex flex-row project-card h-5/6 w-9/12 m-auto">
                    ...
                    <div class="flex flex-col h-full w-full">
                        ...
                        <div class="flex flex-col h-full w-full">
                            <div class="flex h-4/6 w-full">
                                <h1 class="portfolio-title text-5xl p-5 mt-5">Dino Game in Python</h1>
                            </div>
                            <div class="flex h-4/6 w-full">
                        ...
                        <div class="flex flex-row h-3/6 w-full">
                            ...
                            <div class="flex h-full w-full">
                                <a class="m-auto" href="https://github.com/Subhayan0022/DinoClone" target="_blank" rel="noopener noreferrer">
                                    <button class="project-button rounded-xl px-8">Go to code</button>
                                </a>
                            </div>
                        </div>
